          ...
          <div key={i}>
            ...
            >
              ...
              <div className="flex sm:flex-col gap-4 sm:gap-2 sm:w-48 shrink-0">
                <span className="font-agdasima text-white/60 text-lg tracking-widest">
                  {post.date}
                </span>
                <span className="font-afacad text-white/60 text-base border border-white/20 px-3 py-0.5 w-fit">
                  {post.tag}
                </span>
              </div>
              ...
              <div className="flex-1">
                <h2 className="font-afacad text-3xl sm:text-4xl font-semibold leading-tight mb-3 group-hover:underline underline-offset-4 transition-all">
                  {post.title}
                </h2>
                <p className="font-afacad text-white/50 text-xl leading-tight">
                  {post.excerpt}
                </p>
              </div>
